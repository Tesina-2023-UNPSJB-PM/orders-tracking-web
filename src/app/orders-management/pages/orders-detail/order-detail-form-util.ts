...
export function createOrderDetailForm(
  builder: FormBuilder
): OrderDetailFormType {
...
export function initializeFormData(
  form: OrderDetailFormType,
  data: ServiceOrderDetailResponse
) {
  form.setValue({
    formBasic: {
...
function getMasterDataPriority(
  priority: string | undefined
): MasterDataOrderPriorityDTO | null {
...
function getDateEstimatedResolution(
  estimatedResolutionTime: Date | undefined
): Date | null {
